...
Feature: Books module
  ...
  Scenario Outline: Verify added book is matching with DB
    ...
    Examples:
      ...
      | Clean Code B26B6            | 09112021 | 2021 | Robert C.Martin | Drama                |
      | Head First Java B26B6       | 10112021 | 2021 | Kathy Sierra    | Action and Adventure |
      | The Scrum Field Guide B26B6 | 11112021 | 2006 | Mitch Lacey     | Short Story          |